    ...
    switch(spellInfo_1->SpellFamilyName)
    {
        ...
        case SPELLFAMILY_WARLOCK:
            if( spellInfo_2->SpellFamilyName == SPELLFAMILY_WARLOCK )
            {
				...
				// Unstable Affliction and Immolation (By pala)
				if( spellInfo_1->SpellIconID == 31 && spellInfo_2->SpellIconID == 2039 ||
					spellInfo_2->SpellIconID == 31 && spellInfo_1->SpellIconID == 2039 )
						return true;
            }
            // Detect Invisibility and Mana Shield (multi-family check)
        ...
        case SPELLFAMILY_WARRIOR:
            if( spellInfo_2->SpellFamilyName == SPELLFAMILY_WARRIOR )
            {
				...
				// Taste of Blood and Sudden Death (By Pala)
        ...
        case SPELLFAMILY_PALADIN:
            if( spellInfo_2->SpellFamilyName == SPELLFAMILY_PALADIN )
            {
				...
				// Righteous Vengeance and Seal of Vengeance (By Pala)
